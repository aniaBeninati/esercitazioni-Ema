...
const initialInput = { 
  ...
  function App() {
    ...
    const [filter, setFilter] = useState({ tipologia: "", necessita_di_luce: "", frequenza_di_annaffiatura: "", difficolta_di_cura: "" });// Stato per i filtri
   ...
   // Funzione per gestire l'invio del form
    ...
    const filteredPiante = piante.filter((pianta) => {
      return (
        ...
        (!filter.necessita_di_luce || pianta.necessita_di_luce === filter.necessita_di_luce) &&
        (!filter.frequenza_di_annaffiatura || pianta.frequenza_di_annaffiatura === filter.frequenza_di_annaffiatura) &&
        (!filter.difficolta_di_cura || pianta.difficolta_di_cura === filter.difficolta_di_cura)
      );
    });
    ...
    return (
      <div className={styles.container}>
        ...
        <p className={styles.intro}>Scopri le migliori piante da appartamento e impara come prendertene cura!</p>
